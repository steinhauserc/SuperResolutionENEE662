...
function [ images offsets croppedOriginal ] = SynthDataset(im, numImages, blurSigma, scaleFactor)    
    padRatio = 0.2;
    ...
    for i = 1 : numImages
        ...
        curIm = images{i};
        images{i} = curIm(scaleFactor : scaleFactor : end - 1, scaleFactor : scaleFactor : end - 1);
    end
end
